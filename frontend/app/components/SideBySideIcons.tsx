export default function SideBySideIcons() {
  return (
    <div className="relative flex gap-[0] -mt-16 group">
      <div className="z-10 flex aspect-square h-32 w-32 translate-x-2 transform items-center justify-center rounded-full border-4 border-surface-container-lowest bg-surface-container-lowest transition-all duration-300 group-hover:-translate-x-5 group-hover:scale-110">
        <svg
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 scale-50 text-4xl font-bold text-on-surface opacity-0 transition-all duration-300 ease-in-out group-hover:scale-100 group-hover:opacity-100">
        +
      </div>
      <div className="flex aspect-square h-32 w-32 -translate-x-2 transform items-center justify-center rounded-full border-4 border-surface-container-lowest transition-all duration-300 group-hover:translate-x-5 group-hover:scale-110">
        <svg
          className="w-full duration-300 transition"
          viewBox="0 0 180 180"
          fill="none"
